...
needs to be measured to give you a clear idea of 
what your computer(s) is capable of.

Merely relying on specs does not give a full picture
and indeed the specs can be misleading.
...
Release 1.6:
	- Converted the code to object-oriented C.
Release 1.5:
...
Release 0.25 made network bandwidth bidirectional.
