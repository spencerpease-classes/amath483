...
// 1.6.1 Fixes for running on 32-bit Raspberry pi OS Raspbian.
//---------------------------------------------------------------------------
...
#ifdef __arm__
extern int ReaderVector (void* chunk, unsigned long, unsigned long);
extern int RandomReaderVector (unsigned long** chunk_ptrs, unsigned long, unsigned long);
extern int WriterVector (void* chunk, unsigned long, unsigned long, unsigned long);
extern int RandomWriterVector (unsigned long** chunk_ptrs, unsigned long, unsigned long, unsigned long);
#endif
